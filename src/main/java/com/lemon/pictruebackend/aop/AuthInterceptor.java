package com.lemon.pictruebackend.aop;
...
public class AuthInterceptor {
    ...
    public Object doInterceptor(ProceedingJoinPoint joinPoint, AuthCheck authCheck) throws Throwable {
        ...
        // 没有权限，拒绝
        AssertUtils.isNotNull(userRoleEnum, ErrorCode.NO_AUTH_ERROR);

        // 要求必须有管理员权限，但用户没有管理员权限，拒绝
        AssertUtils.isFalse(UserRoleEnum.ADMIN.equals(mustRoleEnum) && !UserRoleEnum.ADMIN.equals(userRoleEnum),
